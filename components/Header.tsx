...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-cream/90 dark:bg-black/90 backdrop-blur-md border-b border-beige-dark/20 dark:border-white/10 transition-colors duration-300">
